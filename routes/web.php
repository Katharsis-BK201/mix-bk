...
//socialite
Route::get('/auth/{provider}/redirect', [LoginBasic::class, 'redirectToProvider'])->name('auth.redirect');
Route::get('/auth/{provider}/callback', [LoginBasic::class, 'providerAuth'])->name('auth.provider');
